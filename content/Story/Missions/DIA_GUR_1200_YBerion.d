...
//	AI_Output(self,other,"DIA_YBerion_Kennen_12_01"); //Ah! Du kommst mir bekannt vor!
	AI_Output(self, other, "DIA_YBerion_Kennen_12_01"); //Ah! Připadáš mi povědomý!
...
//	AI_Output(other,self,"DIA_YBerion_Kennen_15_02"); //Unmöglich. Wir haben uns noch nie gesehen.
	AI_Output(other, self, "DIA_YBerion_Kennen_15_02"); //Vyloučeno. Ještě nikdy jsme se neviděli.
...
//	AI_Output(self,other,"DIA_YBerion_Kennen_12_03"); //Und ich dachte ... Nun gut - was willst du?
	AI_Output(self, other, "DIA_YBerion_Kennen_12_03"); //Ale já myslel... Dobře - co chceš?
};
...
//	AI_Output(self,other,"Sit_2_PSI_Yberion_BringFocus_Info_12_04"); //Du könntest für mich nachsehen, was passiert ist!
	AI_Output(self, other, "Sit_2_PSI_Yberion_BringFocus_Info_12_04"); //Mohl bys pro mě zjistit, co se stalo.
...
//	AI_Output(self,other,"Sit_2_PSI_Yberion_BringFocus_WO_12_02"); //Wenn du das Lager verlässt, wende dich nach rechts und steige hinauf zur großen Klippe. Dort, hinter dem Wald, wo du das Meer sehen kannst, wirst du den Fokus finden.
	AI_Output(self, other, "Sit_2_PSI_Yberion_BringFocus_WO_12_02"); //Vyjdi z tábora, dej se doprava a pak nahoru na vysoký útes. Tam, za lesem až uvidíš moře, najdeš ohnisko.
};
...
//	AI_Output(self,other,"Sit_2_PSI_Yberion_BringFocus_FOKUS_12_02"); //Es ist ein magischer Gegenstand, der unsere geistigen Kräfte vereinigen wird.
	AI_Output(self, other, "Sit_2_PSI_Yberion_BringFocus_FOKUS_12_02"); //Je to magický předmět, který soustředí naši duchovní sílu.
...
//	AI_Output(self,other,"Sit_2_PSI_Yberion_BringFocus_FOKUS_12_04"); //In einer Vision sah ich, dass wir uns die Kraft eines Fokus zu Nutze machen müssen.
	AI_Output(self, other, "Sit_2_PSI_Yberion_BringFocus_FOKUS_12_04"); //V jedné vidině jsem viděl, že musíme využít sílu toho ohniska.
...
//	AI_Output(self,other,"Sit_2_PSI_Yberion_BringFocus_FOKUS_12_06"); //Meine Vision war ein Zeichen vom Schläfer. Mit dem Fokus können wir ihn erreichen!
	AI_Output(self, other, "Sit_2_PSI_Yberion_BringFocus_FOKUS_12_06"); //Moje vidina byla znamením od Spáče. Pomocí ohniska se s ním budeme moci spojit!
};
...
//	AI_Output(self,other,"Info_YBerion_BringFocus_RUNNING_12_02"); //Dann suche weiter. Der Schläfer wird dir den Weg weisen.
	AI_Output(self, other, "Info_YBerion_BringFocus_RUNNING_12_02"); //Tak hledej. Spáč ti ukáže cestu.
};
...
//	AI_Output(self,other,"Info_YBerion_BringFocus_Success_12_02"); //Hervorragend. Du hast uns einen großen Dienst erwiesen.
	AI_Output(self, other, "Info_YBerion_BringFocus_Success_12_02"); //Výborně. Prokázal jsi nám velikou službu.
...
//	AI_Output(self,other,"Info_YBerion_BringFocus_Success_12_03"); //Bring nun den Fokus zu Cor Kalom. Er wird wissen, was zu tun ist.
	AI_Output(self, other, "Info_YBerion_BringFocus_Success_12_03"); //Dones to ohnisko zpátky Cor Kalomovi. Ten bude vědět, co je třeba udělat.
...
//		AI_Output(other,self,"Info_YBerion_BringFocus_Success_15_04"); //Wo kann ich diesen Cor Kalom finden?
		AI_Output(other, self, "Info_YBerion_BringFocus_Success_15_04"); //Kde najdu toho Cor Kaloma?
...
//		AI_Output(self,other,"Info_YBerion_BringFocus_Success_12_05"); //Er hält sich die meiste Zeit im Alchemielabor auf der oberen Stegebene auf.
		AI_Output(self, other, "Info_YBerion_BringFocus_Success_12_05"); //Většinu času tráví ve své alchymistické dílně v horní úrovni můstků.
...
//	AI_Output(other,self,"Info_YBerion_NYRAS_15_02"); //Er faselte davon, dass der Schläfer zu ihm gesprochen habe und ihn als einzigen Diener auserwählte!
	AI_Output(other, self, "Info_YBerion_NYRAS_15_02"); //Říkal, že mluvil se Spáčem, který si ho zvolil za svého služebníka!
...
//	AI_Output(self,other,"Info_YBerion_NYRAS_12_04"); //Die Macht des Schläfers ist so gewaltig, dass sie unvorbereitete Seelen in Verwirrung stürzen kann.
	AI_Output(self, other, "Info_YBerion_NYRAS_12_04"); //Spáčova moc je tak nesmírná, že může uvrhnout nepřipravené duše do zoufalství! #Needs_attention tady je to kostrbaté, ale opsal jsem to z nějakého náboženského textu :D
...
//	AI_Output(other,self,"GUR_1200_Yberion_EARN_Info_15_01"); //Wie sieht's mit einer Belohnung aus?
	AI_Output(other, self, "GUR_1200_Yberion_EARN_Info_15_01"); //Jak to vypadá s mou odměnou?
...
func void GUR_1200_Yberion_LASTWORDS_Info()
{
	...
	AI_Output(self, other, "GUR_1200_Yberion_LASTWORDS_Info_12_01"); //Konec... Spáč... já ho... já HO viděl!
	AI_Output(self, other, "GUR_1200_Yberion_LASTWORDS_Info_12_02"); //Wer...?...du bist es, gut. Hör mir zu....
	AI_Output(self, other, "GUR_1200_Yberion_LASTWORDS_Info_12_02"); //Kdo...? ...To jsi ty, dobře. Poslouchej....
	AI_Output(self, other, "GUR_1200_Yberion_LASTWORDS_Info_12_03"); //Du darfst den Schläfer nicht wecken,... die Wassermagier, ...
	AI_Output(self, other, "GUR_1200_Yberion_LASTWORDS_Info_12_03"); //Nesmíte Spáče probudit,... Mágové Vody, ...
	...
	AI_Output(self, other, "GUR_1200_Yberion_LASTWORDS_Info_12_05"); //Musíš za nimi jít. Jim se povede nás odsud dostat.
	AI_Output(self, other, "GUR_1200_Yberion_LASTWORDS_Info_12_06"); //Der Schläfer...Ich sah ihn. Er ist ein ...ein ....Dämon!
	AI_Output(self, other, "GUR_1200_Yberion_LASTWORDS_Info_12_06"); //Spáč... Já ho viděl, On je... je... démon!
	...
	AI_Output(self, other, "GUR_1200_Yberion_LASTWORDS_Info_12_07"); //Pokud stále chce Bariéru zničit,... Jdi do Nového tábora. Řekni jim o ohnisku. Řekni jim...
