...
func void Npc_SetStateTime(VAR C_NPCself, var int seconds) { };
...
func void AI_QuickLook(VAR C_NPCself, var C_Npc other) { };
// NSC kurz ( 2 sec) anschauen ( nur Kopf bewegt sich )
func void AI_LookAt(VAR C_NPCself, var string name) { };
// Schaue auf einen Wegpunkt (Wegpunktname angeben) oder auf ein anderes Objekt (Vobname angeben)
func void AI_LookAtNpc(VAR C_NPCself, var C_Npc other) { };
// Schaue zu einem NSC
func void AI_StopLookAt(var C_Npc self) { };
// wieder geradeaus schauen
func void AI_PointAt(VAR C_NPCself, var string name) { };
// Zeige auf einen Wegpunkt (Wegpunktname angeben) oder auf ein anderes Objekt (Vobname angeben)
func void AI_PointAtNpc(VAR C_NPCself, var C_Npc other) { };
// Zeige auf einen NSC
func void AI_StopPointAt(var C_Npc self) { };
// nicht mehr auf etwas zeigen

// ------------------------------------- NSC NIMMT / LEGT WEG -------------------------------
func void AI_TakeItem(VAR C_NPCself, VAR C_ITEM item) { };
// der Npc nimmt mit dieser Funktion die globale Item-Instanz auf
func void AI_DropItem(VAR C_NPCself, var int itemid) { };
// Item(itemid) wird auf den Boden fallen gelassen

// ------------------------------------------- USE ITEM -------------------------------------
func void AI_UseItem(VAR C_NPCself, var int itemInstance) { };
// Item bis zum Ende benutzen
func void AI_UseItemToState(VAR C_NPCself, var int itemInstance, var int state) { };
// Item benutzen bis zum angegebenen State

// ---------------------------------------- NSC BENUTZT MOB ---------------------------------

func int AI_UseMob(VAR C_NPCself, var string schemeName, var int targetState) { return 0; };
...
func int Wld_IsMobAvailable(VAR C_NPCself, var string schemeName) { };
...
func int Wld_GetMobState(var C_NPCself, var string schemeName);
...
func void AI_GotoFP(VAR C_NPCself, var string fpName) { };
...
func void AI_GotoNextFP(var C_NPCself, var string fpName) { };
//wie AI_GotoFP() allerdings Suchkriterium wie bei Wld_IsNextFPAvailable()
func void AI_GotoNpc(VAR C_NPCself, var C_Npc other) { };
// "self" geht zu "other"
func void AI_GotoItem(VAR C_NPCself, VAR C_ITEM item) { };
// "self" geht zu "item"
func void AI_GotoSound(var C_Npc n0) { };
// Npc läuft zum Sound
func void AI_Teleport(var C_NPCself, var string waypoint);
...
// -------------------------------------------------------------------------------------------
func int Wld_IsFPAvailable(VAR C_NPCself, var string fpName) { };
...
func int Wld_IsNextFPAvailable(var C_NPCself, var string fpName)
//  wie Wld_IsFPAvailable(), aber es wird immer der nahegelegenste genommen und 'self' zählt als Blockierer!
func int Npc_IsOnFP(VAR C_NPCself, var string name)
...
func void AI_WhirlAround(VAR C_NPCself, var C_Npc other) { };
...
func void Mdl_RemoveOverlayMDS(VAR C_NPCself, var string overlayName) { };
// Entferne ein Overlay-MDS
func void Mdl_ApplyOverlayMDSTimed(VAR C_NPCself, var string overlayname, var float timeTicks);
...
func void Mdl_StartFaceAni(VAR C_NPCself, var string name, var float intensity, var float holdTime) { };
// Starte Gesichtsanimation // intensity 1 = 100% // holdTime -1 = forever
func void Mdl_ApplyRandomFaceAni(VAR C_NPCself, var string name, var float timeMin, var float timeMinVar, var float timeMax, var float timeMaxVar, var float probMin) { };
...
func int Npc_HasBodyFlag(VAR C_NPCself, var int bodyFlag) { };
...
func void Npc_SetToFightMode(VAR C_NPCself, var int weapon) { };
// Setzt den NSC beim Start in den der Waffe entsprechenden Kampfmodus (Waffe wird erzeugt)
func int Npc_IsInFightMode(VAR C_NPCself, var int fmode) { return 0; };
...
//				Npc_PerceiveAll() erstellt wurde. Wird diese Funktion in einem Zustand ohne aktive
//				Wahrnehmungen benutzt, muß vorher ein Npc_PerceiveAll() aufgerufen werden
func void Npc_SetTarget(var C_NPCself, var C_Npc other)
...
// wurde.
func void AI_FinishingMove(var C_NPCself, var C_Npc other)
...
func int Npc_AreWeStronger(VAR C_NPCself, var C_Npc other) { return 0; };
...
func int Npc_IsAiming(VAR C_NPCself, var C_Npc other) { return 0; };
...
func void AI_LookForItem(VAR C_NPCself, var int instance) { };
...
FUNC C_Item Npc_GetInvItem(VAR C_NPCself, var int itemInstance) { };
...
func int Npc_GetInvItemBySlot(VAR C_NPCself, var int category, var int slotNr)
...
func int Npc_StartItemReactModules(VAR C_NPCself, var C_Npc other, VAR C_ITEM item) { return 0; };
...
func int Npc_HasOffered(VAR C_NPCself, var C_Npc other, var int itemInstance) { return 0; };
...
func void AI_Output(VAR C_NPCself, var C_Npc target, var string outputName) { };
// Cutscene mit entsprechender Id wird abgenudelt
func void AI_OutputSVM(VAR C_NPCself, var C_Npc target, var string svmname) { };
// Outputbefehl um Svms abzuspielen
func void AI_OutputSVM_Overlay(VAR C_NPCself, var C_Npc target, var string svmname) { };
...
// -------------------------------------------------------------------------------------------
func void AI_Ask(VAR C_NPCself, var func anserYes, var func answerNo) { };
...
func void Npc_MemoryEntry(VAR C_NPCself, var int source, var C_Npc offender, var int newsid, var C_Npc victim) { };
...
func void Npc_MemoryEntryGuild(VAR C_NPCself, var int source, var C_Npc offender, var int newsid, var C_Npc victimguild) { };
// wie MemoryEntry nur, das die Memory für die ganze Gilde kreiert wird
func int Npc_HasNews(VAR C_NPCself, var int newsID, var C_Npc offender, var C_Npc victim) { };
...
func int Npc_IsNewsGossip(VAR C_NPCself, var int newsNumber) { };
// Liefert >0, falls News "Gossip" ist
FUNC C_NPC Npc_GetNewsWitness(VAR C_NPCself, var int newsNumber) { };
// Ermittle Zeuge der News und gibt eine INstanz der Klasse C_Npc zurück
FUNC C_NPC Npc_GetNewsVictim(VAR C_NPCself, var int newsNumber) { };
// Ermittle Opfer der News und gibt eine INstanz der Klasse C_Npc zurück
FUNC C_NPC Npc_GetNewsOffender(VAR C_NPCself, var int newsNumber) { return 0; };
...
func int Npc_KnowsInfo(VAR C_NPCself, var int infoInstance) { return 0; };
...
func int Npc_HasDetectedNpc(VAR C_NPCself, var C_Npc other) { return 0; };
...
func int Npc_IsNear(VAR C_NPCself, var C_Npc other) { return 0; };
...
func int Npc_GetDistToWP(VAR C_NPCself, var string wpName)
...
func void Npc_SetAttitude(VAR C_NPCself, var int att) { };
//  setzt die permanente Attitüde auf einen festen Wert
func void Npc_SetTempAttitude(VAR C_NPCself, var int att) { };
//   setzt die temporäre Attitüde auf einen Wert (att)
func int Npc_GetAttitude(VAR C_NPCself, var C_Npc other) { return 0; };
...
func int Npc_GetPermAttitude(var C_NPCself, var C_Npc other) { };
...
// -------------------------------------------------------------------------------------------
func void Npc_SetKnowsPlayer(var C_NPCself, var C_Npc player) { };
// NSC kennt SC
func int Npc_KnowsPlayer(VAR C_NPCself, var C_Npc player) { return 0; };
...
// ---------------------------------------------- ZS -----------------------------------------
func void AI_StartState(VAR C_NPCself, var func what, var int stateBehaviour, var string wpName) { };
...
func void AI_SetNpcsToState(var C_NPCself, var func aiStateFunc, var int radius) { };
...
// -> FINGER WEG!!! (SN)
// -------------------------------------------------------------------------------------------
func int Npc_IsInState(VAR C_NPCself, var func state) { return 0; };
// Abfrage auf den aktuellen Zustand einer Spielfigur True/False
func int Npc_WasInState(VAR C_NPCself, var func state) { return 0; };
// Abfrage auf den vorherigen Zustand einer Spielfigur True/False

// ---------------------------------------------- TA -----------------------------------------
func void TA(var c_npcself, var int start_h, var int stop_h, var func state, var string waypoint) { };
// Mit _(Zustandsname) wird ein neuer Tagesablauf generiert, siehe TA.d
func void TA_Min(var c_npcself, var int start_h, var int start_m, var int stop_h, var int stop_m, var func state, var string waypoint) { };
// Tagesablaufpunkt minutengenau angeben
func void AI_ContinueRoutine(var C_Npc self) { };
// Setze Tagesablauf fort
// Enthält Standup
// -------------------------------------------------------------------------------------------
func int Npc_IsInRoutine(VAR C_NPCself, var func state) { return 0; };
// Check ob der angegebene Zustand der aktuelle TA des NSCs ist. True/FAlse
func void Npc_ExchangeRoutine(VAR C_NPCself, var string routineName) { };
...
func void Mdl_SetModelScale(VAR C_NPCself, var float x, var float y, var float z) { };
// zum skalieren des Meshes (Breite,Höhe,Tiefe) 1 = 100%, also Normalgröße!
func void Mdl_SetModelFatness(var C_NPCself, var float fatness) { };
...
func void Npc_ChangeAttribute(var C_NPCself, var int atr, var int value) { };
...
func int Npc_HasTalent(VAR C_NPCself, var int tal) { return 0; };
// liefert eins zurück, wenn der geprüfte Charakter das Talent tal hat
func int Npc_HasFightTalent(VAR C_NPCself, var int tal) { return 0; };
...
// ????
func void AI_ReadySpell(VAR C_NPCself, var int spellID, var int investMana);
func void AI_UnreadySpell(var C_Npc self);
func int Npc_HasSpell(VAR C_NPCself, var int spellID);

// *******************************************************************************************
// *** WAHRNEHMUNGEN ***
// *******************************************************************************************

func void Npc_PercEnable(VAR C_NPCself, var int percID, var func function) { };
// Aktiviere Perception
func void Npc_PercDisable(VAR C_NPCself, var int percID) { };
// Deaktiviere Perception
func void Npc_SetPercTime(VAR C_NPCself, var float seconds) { };
...
func void Npc_SendSinglePerc(VAR C_NPCself, var C_Npc target, var int percID) { };
...
func int Wld_DetectNpc(VAR C_NPCself, var int instance, var func aiState, var int guild) { return 0; };
...
var int Wld_DetectNpcEx(VAR C_NPCself, var int npcInstance, var func aiState, var int guild, var int detectPlayer)
// Wie Wld_DetectNpc(). Zusätzlich kann per detectPlayer=0 der Spieler ignoriert werden.
func int Wld_DetectItem(VAR C_NPCself, var int flags) { return 0; };
...
func int Npc_CanSeeNpcFreeLOS(VAR C_NPCself, var C_Npc other) { };
...
func void TA_CS(VAR C_NPCself, var string csName, var string roleName) { };
...
func void AI_PlayCutscene(VAR C_NPCself, var string csName) { };
